...
import Carpets_image from "./Carpets_image.jpg";
import coming_soon from "./coming_soon.png";
import Pottery_image from "./Pottery_image.jpg";
import Statues_image from "./Statues_image.png";
import Traditional_Paintings from "./Traditional_Paintings.jpg";
import Textiles_image from "./Textiles_image.jpg";
import wood_image from "./wood_image.jpg";
import remove_icon from "./remove_icon.svg";
import modern_images from "./modern_images.jpg";
...
import approved_icon from "./approved_icon.png";
import rejected_icon from "./rejected_icon.png";
...
export const categories = [
  {
    text: "Textiles & Clothing",
    path: "Textiles-and-clothing",
    image: Textiles_image,
    bgColor: "#000000 ",
  },
  {
    text: "Pottery & Ceramics",
    path: "Pottery-Ceramics",
    image: Pottery_image,
    bgColor: "#000000",
  },
  {
  ...
  },
  {
    ...
    path: "Traditional-Paintings",
    image: Traditional_Paintings,
    bgColor: "#000000",
  },
  {
    text: "Carpets & Rugs",
  ...
  {
    text: "Statues & Sculptures",
    path: "Statues-Sculptures",
    image: Statues_image,
    bgColor: "#000000",
  },
  {
...
export const footerLinks = [
  {
    ...
    links: [
      ...
      { text: "Join as Producer", url: "/producerform" },
      { text: "About Us", url: "#" },
    ],
  },
  {
    title: "Need help?",
    links: [
      { text: "Contact us", url: "mailto:info@oneplanetmarket.com" },
    ]
  },
  {
    title: "Follow Us",
